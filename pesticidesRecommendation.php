<?php
    ...
    //function for displaying the image file
    if (isset($_POST["image_upload"])) {
        ...
        if (isset($_FILES["image"])) {
            ...
            if ($check !== false) {
                ...
                echo "<div class='alert alert-warning' role='alert'>রোগাক্রান্ত পাতার ইমেজ ফাইল আপলোড করুন...</div>";
                $uploadOk = 0;
            }
        }
        ...
        /*if (file_exists($targetFile)) {
            echo "<div class='alert alert-warning m-0' role='alert'>দুঃখিত, আপনি এই ছবিটি পূর্বে একবার ব্যাবহার করেছেন।</div>";
            $uploadOk = 0;
        }*/
        ...
        if ($_FILES["image"]["size"] > 500000) {
            echo "<div class='alert alert-warning' role='alert'>অপেক্ষাকৃত ছোট সাইজের ইমেজ ফাইল আপলোড করুন...</div>";
            $uploadOk = 0;
        }
        ...
        if (
            ...
            echo "<div class='alert alert-warning' role='alert'>দুঃখিত, শুধুমাত্র JPG, JPEG, PNG এবং GIF ফাইলগুলি অনুমোদিত।</div>";
            $uploadOk = 0;
        }
    
        // Check if $uploadOk is set to 0 by an error
        if ($uploadOk == 0) {
            /*echo "<div class='alert alert-danger m-0' role='alert'>দুঃখিত, আপনার ইমেজ ফাইলটি আপলোড হয়নি।</div>";*/
        } else {
            if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
                /*echo "<div class='alert alert-success' role='alert'>আপনার ইমেজ ফাইলটি " . htmlspecialchars(basename($_FILES["image"]["name"])) . "সফলভাবে আপলোড হয়েছে।</div>";*/
            } else {
                echo "<div class='alert alert-danger' role='alert'>দুঃখিত, আপনার ইমেজ ফাইলটি আপলোড করার সময় ত্রুটি হচ্ছে।</div>";
            }
        }
    }
    ...
    <div class="container">
        <div class="text-center" style="max-width:600px; margin: 0 auto" >
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <input class="form-control form-control-sm focus-ring focus-ring-success border-success" type="file" name="image" id="image">
                <button class="btn btn-success my-4" type="submit" id="submitButton" name="image_upload">পাতার ছবি আপলোড করুন</button>
            </form>
        </div>
        ...
        <div class="text-left" style="max-width:600px; margin: 0 auto" >
            ...
            <?php if (isset($_FILES["image"]) && $uploadOk == 1) : ?>
                <h3 class="text-center">রোগাক্রান্ত পাতার ছবি:</h3>
                <img class="rounded mx-auto d-block" src="<?php echo $targetFile; ?>" alt="আপলোডকৃত ছবি" width="100%" height="auto" style="max-width: 256px;">
            <?php endif; ?>

            <!-- Result from Uploading Image File -->
            <?php
                if (isset($result)) {
                    echo '<h3 class="my-3 text-center">পাতার আপলোডকৃত ছবি থেকে প্রদত্ত ফলাফল:</h3>' . $result;
                }
            ?>
